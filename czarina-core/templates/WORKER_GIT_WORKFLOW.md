...
🤖 Generated by {{WORKER_ID}} - Multi-Agent Orchestration
EOF
)"
```
...
- ❌ Don't force push (`git push -f`) without good reason
- ❌ Don't create PRs to wrong base branch
- ❌ Don't merge your own PRs (unless explicitly told)
