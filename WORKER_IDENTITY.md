...
You are the **memory-core** worker in this czarina orchestration.

## Your Role
Implement memory file structure and basic I/O

## Your Instructions
Full task list: $(pwd)/../workers/memory-core.md

Read it now:
```bash
cat ../workers/memory-core.md | less
```

Or use this one-liner to start:
```bash
cat ../workers/memory-core.md
```

## Quick Reference
- **Branch:** cz1/feat/memory-core
- **Location:** /home/jhenry/Source/czarina/.czarina/worktrees/memory-core
- **Dependencies:** None
...
## Your Mission
1. Read your full instructions at ../workers/memory-core.md
